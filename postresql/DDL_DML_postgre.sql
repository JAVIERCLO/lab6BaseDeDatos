...
CREATE TABLE salesRep(
    ...
    name VARCHAR(50),
    age INTEGER,
    rep_office INTEGER REFERENCES offices(office),
    title VARCHAR(50),
    hire_date DATE,
    manager INTEGER REFERENCES salesRep(empl_num),
    quota NUMERIC(10,2),
    sales NUMERIC(10,2)
);
...
CREATE TABLE customers(
    ...
    company VARCHAR(100),
    cust_rep INTEGER REFERENCES salesRep(empl_num),
...
CREATE TABLE orders (
    ...
    order_date DATE,
    cust INTEGER REFERENCES customers(cust_num),
    rep INTEGER REFERENCES salesRep(empl_num),
    mfr CHAR(3),
    product CHAR(5),
    qty INTEGER,
    amount NUMERIC(10,2),
